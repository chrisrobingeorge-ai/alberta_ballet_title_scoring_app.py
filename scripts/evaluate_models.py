...
and evaluates a simple mean baseline model.
...
def main():
    ...
    # Calculate Mean Baseline prediction
    mean_baseline = np.mean(y_train)
    
    # Predict: use training mean for all test samples
    ...
    # Print results
    print("-" * 70)
    print("RESULTS: Mean Baseline Model")
    print("-" * 70)
    print(f"Training mean: {mean_baseline:.2f} tickets")
    print(f"Test MAE:      {mae_baseline:.2f} tickets")
    print("-" * 70)
    print()
    
    # Additional context
    print("Context:")
    print(f"  - Test set actual mean:   {np.mean(y_test):.2f} tickets")
    print(f"  - Test set actual median: {np.median(y_test):.2f} tickets")
    print(f"  - Test set std dev:       {np.std(y_test):.2f} tickets")
    print()
    print("=" * 70)
